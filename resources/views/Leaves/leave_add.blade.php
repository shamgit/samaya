...
<main class="main-content">
  ...
  <div class="detail-card">
    ...
    <div class="section-block">
      ...
      <form   method="POST" action="{{ route('store_leave') }}" enctype="multipart/form-data">
       @csrf
      <div class="form-row">
      ...
      <div class="form-row">
			...
			<div class="form-group">
			  ...
			  <div class="input-group date_picker">
				<input type="text" class="form-control" name="from_date"  id="f_requestDate" placeholder="Select date" readonly />
		...
		<div class="form-row">
           ...
           <div class="form-group">
			  ...
			  <div class="input-group date_picker">
				<input type="text" class="form-control" name="to_date"  id="t_requestDate" placeholder="Select date" readonly />
				<span class="input-group-text bg-white">
				  <svg width="13" height="13" viewBox="0 0 16 16" fill="none"><rect x="2" y="3" width="12" height="11" rx="2" stroke="#6c757d" stroke-width="1.2"/><path d="M5 2v2M11 2v2M2 7h12" stroke="#6c757d" stroke-width="1.2" stroke-linecap="round"/></svg>
				</span>
			  </div>
		...
		<div class="form-group">
			...
			<textarea type="text" name="reason" class="form-input" required></textarea>
		</div>
    </div>
...
flatpickr("#t_requestDate", { dateFormat: "d M Y", defaultDate: "today" });
