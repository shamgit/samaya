...
<main class="main-content">
  ...
  <div class="detail-card">
    ...
    <form method="POST" action="{{ route('update_payroll') }}" enctype="multipart/form-data">
      @csrf
      <input type="hidden" name="payroll_id" value="{{ $payroll_details->payroll_id }}">
      <div class="form-row">
          <div class="form-group">
              ...
              <select class="form-input" name="employee_id" id="employee_id" required>
                  <option value="">Select Employee</option>
                    ...
                    <option value="{{ $employee->employee_id }}" {{ $payroll_details->employee_id == $employee->employee_id ? 'selected' : '' }}>
          ...
          <div class="form-group">
              ...
              <input type="text" class="form-input" name="employee_code" id="employee_code" value="{{ $payroll_details->employee_code }}" placeholder="EMP-104" readonly />
          </div>
      </div>
      <div class="form-row">
          <div class="form-group">
                  ...
                  <option value="">Select Designation</option>
                    @foreach($designations as $designation)
                        ...
                        <option
                            ...
                            {{ $payroll_details->designation_id == $designation->designation_id ? 'selected' : '' }}
                        >
                            {{ $designation->name }}
                        </option>
                  ...
                  <option value="">Select Department</option>
                   @foreach($departments as $department)
                        <option
                            ...
                            {{ $payroll_details->department_id == $department->department_id ? 'selected' : '' }}
                        >
                            {{ $department->name }}
                        </option>
          ...
          <div class="form-row">
              <div class="form-group">
                  ...
                  <div class="input-group date_picker">
                      <input type="text" class="form-control" id="s_requestDate" name="pay_period_start_date"  value="{{ $payroll_details->pay_period_start_date }}" placeholder="Select date" readonly />
              ...
              <div class="form-group">
                  ...
                  <div class="input-group date_picker">
                      <input type="text" class="form-control" id="e_requestDate" name="pay_period_end_date"  value="{{ $payroll_details->pay_period_end_date }}" placeholder="Select date" readonly />
                      <span class="input-group-text bg-white">
                        <svg width="13" height="13" viewBox="0 0 16 16" fill="none"><rect x="2" y="3" width="12" height="11" rx="2" stroke="#6c757d" stroke-width="1.2"/><path d="M5 2v2M11 2v2M2 7h12" stroke="#6c757d" stroke-width="1.2" stroke-linecap="round"/></svg>
                      </span>
                  </div>
              ...
              <div class="form-group">
                  ...
                  <div class="input-group date_picker">
                      <input type="text" class="form-control" id="f_requestDate" name="pay_date" value="{{ $payroll_details->pay_date }}" placeholder="Select date" readonly />
                    <span class="input-group-text bg-white">
                        <svg width="13" height="13" viewBox="0 0 16 16" fill="none"><rect x="2" y="3" width="12" height="11" rx="2" stroke="#6c757d" stroke-width="1.2"/><path d="M5 2v2M11 2v2M2 7h12" stroke="#6c757d" stroke-width="1.2" stroke-linecap="round"/></svg>
                    </span>
                  </div>
      ...
      <div class="section-block">
          ...
          <div class="form-row">
              <div class="form-group">
                  ...
                  <input type="text" class="form-input calc" name="basic_salary" id="basic_salary" value="{{ $payroll_details->basic_salary }}" placeholder="0" required />
              </div>
          </div>
      </div>
      ...
      <div class="section-block">
          ...
          <div class="form-row">
              <div class="form-group">
                  ...
                  <input type="text" class="form-input calc" name="hra" id="hra" value="{{ $payroll_details->hra }}" placeholder="0" required />
              </div>
              <div class="form-group">
                  <label class="form-label">Transport Allowance <span class="text-danger">*</span></label>
                  <input type="text" class="form-input calc" name="transport_allowance" value="{{ $payroll_details->transport_allowance }}" id="transport_allowance" placeholder="0" required />
              </div>
          </div>
          <div class="form-row">
              <div class="form-group">
                  <label class="form-label">Other Allowance <span class="text-danger">*</span></label>
                  <input type="text" class="form-input calc" name="other_allowance" id="other_allowance" value="{{ $payroll_details->other_allowance }}" placeholder="0" required />
              </div>
              <div class="form-group">
                  <label class="form-label">Total Allowance <span class="text-danger">*</span></label>
                  <input type="text" class="form-input calc" name="total_allowance" id="total_allowance" value="{{ $payroll_details->total_allowance }}" placeholder="0" readonly />
              </div>
          </div>
      </div>
      ...
      <div class="section-block">
          ...
          <div class="form-row">
              <div class="form-group">
                  ...
                  <input type="text" class="form-input calc" name="pf" id="pf"  value="{{ $payroll_details->pf }}" placeholder="0" required />
              </div>
              <div class="form-group">
                  <label class="form-label">Professional Tax <span class="text-danger">*</span></label>
                  <input type="text" class="form-input calc" name="professional_tax" id="professional_tax"  value="{{ $payroll_details->professional_tax }}" placeholder="0" required />
              </div>
          </div>
          <div class="form-row">
              <div class="form-group">
                  <label class="form-label">Other Deductions <span class="text-danger">*</span></label>
                  <input type="text" class="form-input calc" name="other_deduction" id="other_deduction"   value="{{ $payroll_details->other_deduction }}" placeholder="0" required />
              </div>
              <div class="form-group">
                  <label class="form-label">Total Deductions <span class="text-danger">*</span></label>
                  <input type="text" class="form-input calc" name="total_deduction" id="total_deduction"  value="{{ $payroll_details->total_deduction }}" placeholder="0" readonly />
              </div>
          </div>
      </div>
      ...
      <div class="section-block">
          ...
          <div class="form-row">
              <div class="form-group">
                  ...
                  <input type="text" class="form-input calc" name="income_tax" id="income_tax" value="{{ $payroll_details->income_tax }}" placeholder="0" required />
              </div>
          </div>
      </div>
      ...
      <div class="section-block">
          ...
          <div class="form-row">
              <div class="form-group">
                  ...
                  <input type="text" class="form-input calc" name="net_basic_salary" id="net_basic_salary" value="{{ $payroll_details->net_basic_salary }}"  placeholder="0" readonly />
              </div>
              <div class="form-group">
                  <label class="form-label">Allowance</label>
                  <input type="text" class="form-input calc" name="net_allowance" id="net_allowance" value="{{ $payroll_details->net_allowance }}" placeholder="0" readonly />
              </div>
          </div>
          <div class="form-row">
              <div class="form-group">
                  <label class="form-label">Deductions</label>
                  <input type="text" class="form-input calc" name="net_deduction" id="net_deduction" value="{{ $payroll_details->net_deduction }}" placeholder="0" readonly />
              </div>
              <div class="form-group">
                  <label class="form-label">Net Salary</label>
                  <input type="text" class="form-input calc" name="net_salary"  id="net_salary" value="{{ $payroll_details->net_salary }}" placeholder="0" readonly />
              </div>
          </div>
      </div>
      ...
      <div class="section-block text-end">
          ...
          <button type="submit"  name="action" value="save" class="btn-save">Save Payroll</button>
            @if($payroll_details->payroll_status = 2)  
                <input type="hidden" name="payroll_id" value="{{ $payroll_details->payroll_id }}">
                <button type="submit" name="action" value="process" class="btn-po" >
                    Process Payroll
                </button>
            @endif
           </form>
            @if($payroll_details->payroll_status = 3)
                <a href="{{ route('generate_payslip', base64_encode($payroll_details->payroll_id)) }}"
                class="btn-save2">
                    Generate Payslip
                </a>
            @endif
