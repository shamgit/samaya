    ...
    <div class="page-header">
      ...
      <div class="header-actions">
        ...
        <button class="btn-add" data-bs-toggle="modal" data-bs-target="#masteradd">
          ...
          <span class="add-txt">Add Menu </span>
        </button>
      </div>
    </div>
  ...
  <div class="modal fade" id="masteradd" tabindex="-1" aria-labelledby="masteraddLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <form id="createMenuForm" method="POST" action="{{ route('menu_store') }}">
            @csrf
            <div class="modal-body">
            <div class="section-block p-2"> 
                <div class="form-group">
                  <label class="form-label">Menu Name *</label>
                  <input type="text" class="form-input" name="menu_name" required placeholder="Menu Name"/>
                </div>
                 <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-input" name="menu_link" required placeholder="Menu Iink"/>
                </div>
                <div class="form-group">
                  <label class="form-label">Menu Icon *</label>
                  <input type="text" class="form-input" name="menu_icon" required placeholder="Menu Icon"/>
                </div>
                <div class="text-end">
    ...
    <div class="table-card">
      <div class="table-scroll">
        <table class="supplier-table" id="MenuTable">
          <thead>
            <tr>
              <th>Menu  ID</th>
              <th>Menu Name</th>
...
<!-- Edit Role Modal -->
<div class="modal fade" id="editMenuModal" tabindex="-1" aria-labelledby="masteraddLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form  method="POST" action="{{ route('menu_updated') }}">
		 @csrf
...
$(document).ready(function() {
  $(document).on('click', '.edit_model_btn', function() {
	    ...
	    var menu_id = rowData.menu_id;
	    // console.log('Delete ID:', menu_id);

        $.ajax({
            url: 'menu_edit/' + menu_id, 
            type: "GET",
            data: {
                "_token": "{{ csrf_token() }}" 
            },
 ...
 $(document).ready(function () {      
   $('#createMenuForm').validate({
       ...
       messages: {
        ...
        messages: {
           menu_group_id: "Select Menu Group"
       },
        messages: {
           menu_link: "Please enter a menu link"
       },
       messages: {
           menu_icon: "Please enter a menu icon"
       }
   });
});
</script>
