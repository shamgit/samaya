  ...
  <div class="page-header">
    ...
    <div class="header-actions">
      ...
      <button class="btn-add" data-bs-toggle="modal" data-bs-target="#masteradd">
        ...
        <span class="add-txt">Add Leave Type</span>
      </button>
    </div>
  </div>
...
<!-- Add Masters -->
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <form id="createLeaveTypesForm" method="POST" action="{{ route('leave_types_store') }}">
            @csrf
            <div class="modal-body">
            <div class="section-block p-2"> 
                <div class="form-group">
                  <label class="form-label">Leave Type Name <span class="text-danger">*</span></label>
                  <input type="text" class="form-input" name="name" required placeholder="Leave Type Name"/>
                </div>
                <div class="text-end">
  ...
  <div class="table-card">
    <div class="table-scroll">
      <table class="supplier-table" id="LeaveTypesTable">
        <thead>
          <tr>
            <th>Leave Type ID</th>
...
<div class="modal fade" id="editLeaveTypesModal" tabindex="-1" aria-labelledby="masteraddLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form  method="POST" action="{{ route('leave_types_updated') }}">
		     @csrf
...
$(document).ready(function () {
    ...
    let table = $('#LeaveTypesTable').DataTable({
        ...
        ajax: {
            ...
            url: "{{ route('leave_types_list_table') }}",
            ...
            data: function (d) {
                ...
                d._token = "{{ csrf_token() }}";
                dleave_type_id = $('#categoryFilter').val();
...
$(document).ready(function() {
  $(document).on('click', '.edit_model_btn', function() {
	    ...
	    var leave_type_id = rowData.leave_type_id;
	    // console.log('Delete ID:', leave_type_id);
...
$(document).on('click', '.deleteRoleBtn', function () {
    ...
    let leave_type_id = $(this).data('id');
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.status == true) {
                        ...
                        $('#LeaveTypesTable').DataTable().ajax.reload();
