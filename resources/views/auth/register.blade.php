...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .Conf-toggle:hover { color: var(--text); }
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Name -->
         <div class="field-wrap">
            ...
            <x-text-input id="name" class="form-control-pill" type="text" name="name" :value="old('name')"  placeholder="Enter Name" required autofocus autocomplete="name" />
        ...
        <!-- Email Address -->
         <div class="field-wrap">
            ...
            <x-text-input id="email"  class="form-control-pill" type="email" name="email" :value="old('email')" required  placeholder="Enter Email" autocomplete="username" />
        ...
        <!-- Password -->
         <div class="field-wrap">
            ...
            <x-text-input id="password"  class="form-control-pill"
                            type="password"
                            name="password"
        ...
        <!-- Confirm Password -->
         <div class="field-wrap">
            ...
            <x-text-input id="password_confirmation" class="form-control-pill"
                            type="password"
            ...
            <x-input-error :messages="$errors->get('password_confirmation')" class="mt-2" />
             <button
                ...
                id="ConfToggle"
            >
                <i class="bi bi-eye-slash text-center mt-4" id="ConfIcon"></i>
            </button>
        </div>
        ...
        <p class="forgot-link d-flex gap-2 justify-content-center mb-0">{{ __('Already registered?') }} <a  href="{{ route('login') }}">Sing In </a></p>
    </form>
  </div>
</div>
</body>
...
<script>
    ...
    ConfToggle.addEventListener('click', function () {
        ...
        if (password_confirmation.type === 'password') {
            ...
            ConfIcon.classList.remove('bi-eye-slash');
            ConfIcon.classList.add('bi-eye');

        } else {

            password_confirmation.type = 'password';

            ConfIcon.classList.remove('bi-eye');
            ConfIcon.classList.add('bi-eye-slash');
        }
    });
</script>
