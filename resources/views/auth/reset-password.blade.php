    ...
    <p class="card-subtitle"> Reset Password.</p>
        <form method="POST" action="{{ route('password.store') }}">
            ...
            <div class="field-wrap">
                ...
                <x-text-input id="email" class="form-control-pill" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" />
            ...
            <div class="field-wrap">
                ...
                <x-text-input id="password" class="form-control-pill" type="password" name="password" required autocomplete="new-password" />
