...
<main class="main-content">
  ...
  <div class="detail-card">
    ...
    <div class="section-block">
      ...
      <form id="userForm" method="POST" action="{{ route('users_update') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-row">
            ...
            <div class="form-group password-wrap">
                ...
                <input
                    ...
                    name="password"
                    class="form-input"
                    value="{{ $user_details->plain_password }}"
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <select class="form-input" id="role_id" name="role_id">
                    ...
                    @foreach($roles as $role)
                        ...
                        {{ $user_details->role_id == $role->role_id ? 'selected' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-input" id="status" name="status">
                    ...
                    <option value="2"
                        {{ $user_details->status == 2 ? 'selected' : '' }}>
