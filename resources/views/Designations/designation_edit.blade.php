    ...
    <div class="detail-card">
        ...
        <div class="section-block">
            ...
            <form id="DesignationForm"
                  method="POST"
                  action="{{ route('designation_update') }}"
                 ...
                 <!-- User -->
                    <div class="form-group">
                        ...
                        >
                            ...
                            @foreach($users as $user)
                                ...
                                <option value="{{ $user->id }}"  {{ $designation_details->user_id == $user->id ? 'selected' : '' }}>
                     ...
                     <div class="form-group">
                        ...
                        >
                            ...
                            @foreach($roles as $role)
                                ...
                                <option value="{{ $role->role_id }}"  {{ $designation_details->role_id == $role->role_id ? 'selected' : '' }}>
                    ...
                    <!-- <div class="form-group">
                        ...
                        <input
                            ...
                            id="name"
                            name="name"
                            value="{{ $designation_details->name }}"
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                       ...
                       @php
                            ...
                            $selectedMenus = explode(',', $designation_details->access_menus);
                        ...
                        >
                            ...
                            @foreach($menus as $menu)
                                ...
                                <option
                                    ...
                                    {{ in_array($menu->menu_id, $selectedMenus) ? 'selected' : '' }}
                                >
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            id="description"
                            name="description"
                             value="{{ $designation_details->description }}"
