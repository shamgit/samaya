  ...
  <div class="page-header">
    ...
    <div class="header-actions">
      ...
      <button class="btn-add" data-bs-toggle="modal" data-bs-target="#masteradd">
        ...
        <span class="add-txt">Add  Unit of Measure</span>
      </button>
    </div>
  </div>
...
<!-- Add Masters -->
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <form id="createUnitofMeasureForm" method="POST" action="{{ route('unit_store') }}">
            @csrf
            <div class="modal-body">
            <div class="section-block p-2"> 
                <div class="form-group">
                  <label class="form-label"> Unit of Measure Name <span class="text-danger">*</span></label>
                  <input type="text" class="form-input" name="name" required placeholder="Unit of Measure Name"/>
                </div>
                <div class="text-end">
  ...
  <div class="filter-bar">
    ...
    <select class="filter-select" id="categoryFilter">
      <option value="">Unit of Measure: All</option>
  ...
  <div class="table-card">
    <div class="table-scroll">
      <table class="supplier-table" id="UnitofMeasureTable">
        <thead>
          <tr>
...
<div class="modal fade" id="editUnitofMeasureModal" tabindex="-1" aria-labelledby="masteraddLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit Unit of Measure</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
        <form  method="POST" action="{{ route('unit_updated') }}">
		 @csrf
...
$(document).ready(function () {
    ...
    let table = $('#UnitofMeasureTable').DataTable({
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.status == true) {
                        ...
                        $('#UnitofMeasureTable').DataTable().ajax.reload();
...
<script>
 $(document).ready(function () {      
   $('#createUnitofMeasureForm').validate({
       rules: {
           name: {
               required: true
           }
