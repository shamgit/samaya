...
<main class="main-content">
  ...
  <div class="detail-card">
    ...
    <div class="section-block">
      ...
      <form   method="POST" action="{{ route('store_time_tracking') }}" enctype="multipart/form-data">
       @csrf
      <div class="form-row">
    ...
    <div class="section-block">
      ...
      <div class="form-row">
			<div class="form-group">
			  ...
			  <input type="text" class="form-input"  name="project_task" placeholder="Project / Task"/>
			</div>
			<div class="form-group">
			  <div class="form-group">
		...
		<div class="form-row">
			<div class="form-group">
			  ...
			  <input type="time" class="form-input" id="start_time" name="start_time" placeholder="Start Time" required/>
			</div>
			<div class="form-group">
			  <label class="form-label">End Time <span class="text-danger">*</span></label>
			  <input type="time" class="form-input" id="end_time" name="end_time" placeholder="End Time" required/>
			</div>
		</div>
		<div class="form-row">
			<div class="form-group">
			  <label class="form-label">Total Work Hours</label>
			  <input type="text" class="form-input" id="total_work_hours" name="total_work_hours" placeholder="9 hrs" readonly />
			</div>
		...
		<div class="form-group">
			...
			<textarea type="text" name="dask_description" class="form-input" required></textarea>
		</div>
    </div>
